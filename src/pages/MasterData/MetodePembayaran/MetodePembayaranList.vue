...
<template>
    <section class="card-section">
        <div class="uk-flex uk-flex-between">
            <div class="card-heading">Daftar Metode Pembayaran</div>
            <div class="uk-text-right">
                <router-link :to="{name: 'create-metode-pembayaran'}" class="uk-button uk-button-primary button button-primary">
                    Tambah
                </router-link>
            </div>
        </div>
        ...
        <div class="uk-card uk-card-default card-body">
            <table class="uk-table uk-table-divider uk-table-striped uk-table-small uk-table-responsive uk-table-middle uk-table-justify table">
                ...
                <tbody>
                    <tr v-for="data in dataMetodePembayaran" :key="data.id">
                        <td>
                            <router-link :to="{name: 'edit-metode-pembayaran', params: { id: data.id }}" class="uk-width-1-1@s uk-button uk-button-small uk-button-primary button button-primary">
