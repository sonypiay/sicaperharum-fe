...
async function fetchMetodePembayaran() {
    ...
    const fetchApi = await metodePembayaranAPI.detail(id);
...
async function onHandleSubmit() {
    ...
    if( errorDetail.isError === false) {
        const fetchApi = await metodePembayaranAPI.update(formsInput);
...
<template>
    <section class="form-section">
        <div class="form-header-title">Ubah Metode Pembayaran</div>
